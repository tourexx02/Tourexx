const { sendEmailInBackground } = require("./emailService");
...
const sendBookingConfirmationEmail = (booking) => {
	const { firstName, lastName, phone, from, to, type, price, facility, email } =
		booking;
...
Tourex Team`;
	...
	const html = `
		...
		<body>
			<div class="container">
				<div class="header"><h1>Booking Confirmation</h1></div>
				<div class="content">
	...
	sendEmailInBackground(email, subject, text, html);
};
