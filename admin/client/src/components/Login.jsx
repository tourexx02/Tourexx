...
const Login = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#2F4157] to-[#1e2d3d] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
        ...
        <div className="bg-[#2F4157] px-8 py-6 text-center">
          ...
          <p className="text-[#A0C3D2] text-sm">Welcome back to TourEx Admin Panel</p>
        </div>
