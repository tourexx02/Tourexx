...
export const hotelAPI = {
  ...
  getByVendorId: async (vendorId) => {
    try {
      const response = await api.get(`/hotels?vendorId=${vendorId}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching hotels by vendor:', error);
      throw error;
    }
  },
...
export const restaurantAPI = {
  ...
  // Get restaurants by vendor ID
  getByVendorId: async (vendorId) => {
    try {
      const response = await api.get(`/restaurants?vendorId=${vendorId}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching restaurants by vendor:', error);
      throw error;
    }
  },
};
...
export const transportAPI = {
  ...
  // Get transports by vendor ID
  getByVendorId: async (vendorId) => {
    try {
      const response = await api.get(`/transports?vendorId=${vendorId}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching transports by vendor:', error);
      throw error;
    }
  },
};
...
export const tripOrganizerAPI = {
  ...
  // Get trip organizers by vendor ID
  getByVendorId: async (vendorId) => {
    try {
      const response = await api.get(`/trip-organizers?vendorId=${vendorId}`);
      return response.data;
    } catch (error) {
      console.error('Error fetching trip organizers by vendor:', error);
      throw error;
    }
  },
};
...
export const bookingAPI = {
  ...
  getByVendorId: async (vendorId) => {
    try {
      const response = await api.get(`/bookings?vendorId=${vendorId}`);
      return response.data;
    } catch (error) {
