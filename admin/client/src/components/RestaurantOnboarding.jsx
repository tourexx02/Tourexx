...
const RestaurantOnboarding = () => {
  ...
  const filteredRestaurants = restaurants.filter(restaurant => {
    ...
    const matchesApproval = filterApproval === 'all' || 
                           (filterApproval === 'pending' && !restaurant.approved) ||
                           (filterApproval === 'approved' && restaurant.approved);
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {restaurant.vendorId && typeof restaurant.vendorId === 'object' && (
                        <p className="text-gray-500 text-xs">Vendor: {restaurant.vendorId.businessName}</p>
                      )}
                    </div>
                  </div>
